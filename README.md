...
<span class="sd">What is concurrency programming?</span>

<span class="sd">Wiki:</span>
<span class="sd">In computer science, concurrency is a property of systems in which several </span>
<span class="sd">computations are executing simultaneously, and potentially interacting with each other.</span>
...
<span class="sd">What is parallel programming?</span>

<span class="sd">Wiki:</span>
<span class="sd">Parallel computing is a form of computation in which many calculations are </span>
<span class="sd">carried out simultaneously,[1] operating on the principle that large problems</span>
<span class="sd">can often be divided into smaller ones, which are then solved concurrently (&quot;in parallel&quot;).</span>
...
<span class="sd">What is the difference between concurrency programming and parallel programming?</span>

<span class="sd">The main difference seems to be that concurrency programming is</span>
<span class="sd">my dynamic with respect to the means by which the system accomplishes</span>
<span class="sd">interprocess communiation</span>
...
<span class="sd">Why use concurrency programming or parallel programming?</span>



<span class="sd">Concurrency or parallelization are ways of accomplishing more work</span>
<span class="sd">in the same amount of time, essentially.</span>

<span class="sd">~ numbers ~</span>

<span class="sd"> normal execution</span>
<span class="sd"> - 3,000,000 executions in 1 second</span>
<span class="sd"> </span>
<span class="sd"> concurrent execution with 8 cores</span>
<span class="sd"> - 24,000,000 executions in 1 second</span>
<span class="sd"> </span>
...
<span class="sd">The main pieces:</span>



<span class="sd">1. Object to handle setup, inter-process communication, process responses, and process termination</span>

<span class="sd"> sockproc.serversock.MasterProcess</span>
<span class="sd"> </span>
<span class="sd"> a) shared resource for processes to access for their own intialization</span>
<span class="sd"> b) master socket to spawn client sockets and receive process responses</span>
<span class="sd"> c) smooth process termination to give control of the process back to the invoking shell</span>




<span class="sd">2. Object to spawn and execute processes</span>
<span class="sd"> </span>
<span class="sd"> sockproc.spawn.Processes</span>
<span class="sd"> </span>
<span class="sd"> a) instantiated with a number of processes, task, arguments, and optional key word arguments</span>
<span class="sd"> </span>
<span class="sd">&quot;&quot;&quot;</span>
</pre></div>
...
<div class="input_area box-flex1">
<div class="highlight"><pre><span class="sd">&quot;&quot;&quot;</span>
<span class="sd">Let&#39;s start with the first piece</span>

<span class="sd">&quot;&quot;&quot;</span>

<span class="kn">from</span> <span class="nn">sockproc.serversock</span> <span class="kn">import</span> <span class="n">MasterProcess</span>
<span class="n">master</span> <span class="o">=</span> <span class="n">MasterProcess</span><span class="p">(</span><span class="s">&#39;127.0.0.1&#39;</span><span class="p">,</span> <span class="mi">8000</span><span class="p">)</span>



<span class="sd">&quot;&quot;&quot;</span>
<span class="sd">We&#39;ve just created an instance of the object described in 1. Our object</span>
<span class="sd">accomplishes those bullet points, but how?</span>

<span class="sd">1) </span>
<span class="sd"> a) shared resource</span>
<span class="sd"> Prior to being able to simply import an object from this package like shown,</span>
<span class="sd"> we need to install our package.</span>
<span class="sd"> </span>
<span class="sd"> &quot;cd /path/to/this/package&quot;</span>
<span class="sd"> &quot;python setup.py install&quot;</span>
<span class="sd"> </span>
<span class="sd"> MasterProcess checks for and creates a directory called &quot;/etc/ipc&quot; for us to utilize.</span>
<span class="sd"> That directory will contain two things:</span>
<span class="sd"> - A text file identifying our host and port for our MasterProcess </span>
<span class="sd"> socket that we&#39;ll be using to communicate with child processes</span>
<span class="sd"> This is where our processes will look for the information they need</span>
<span class="sd"> to spawn their own sockets to communicate with the master through.</span>
<span class="sd"> </span>
<span class="sd"> - A text file that will contain the process ids of all our</span>
<span class="sd"> child processes. The second part is redundant because there is also an interable</span>
<span class="sd"> attribute of the MasterProcess object that contains those same process ids.</span>
<span class="sd"> </span>

<span class="sd"> </span>
<span class="sd"> </span>
<span class="sd"> b) master socket to spawn client sockets and receive responses</span>
<span class="sd"> </span>
<span class="sd"> The two arguments to MasterProcess are host and port. The host needs to be &#39;127.0.0.1&#39;,</span>
<span class="sd"> but port can be any port. This is the host and port that our socket object will be bound</span>
<span class="sd"> to. This socket object is the &quot;server socket&quot;. It will spawn client sockets for our processes</span>
<span class="sd"> to communicate with. I would refrain from using privileged ports &lt; 1024, though.</span>
<span class="sd"> </span>
<span class="sd"> After we&#39;ve established a connection with a process via a socket, information can freely</span>
<span class="sd"> flow back and forth between those process specific sockets. I can&#39;t speak to their performance</span>
<span class="sd"> in relation to other IPC methods, though.</span>
<span class="sd"> </span>
<span class="sd"> </span>
<span class="sd"> c) smooth process termination to give control of the shell back to the process which spawned</span>
<span class="sd"> all the processes</span>
<span class="sd"> </span>
<span class="sd"> /etc/ipc/pids.txt</span>
<span class="sd"> </span>
<span class="sd"> - this file will be full of our process ids, and will be parsed to kill off those</span>
<span class="sd"> poor processes</span>
<span class="sd"> </span>
<span class="sd">&quot;&quot;&quot;</span>
</pre></div>
...
<div class="input_area box-flex1">
<div class="highlight"><pre><span class="c"># a brief digression on sockets</span>
<span class="kn">import</span> <span class="nn">socket</span>

<span class="n">host</span> <span class="o">=</span> <span class="s">&#39;127.0.0.1&#39;</span>
<span class="n">port</span> <span class="o">=</span> <span class="mi">5555</span>

<span class="n">mastersock</span> <span class="o">=</span> <span class="n">socket</span><span class="o">.</span><span class="n">socket</span><span class="p">(</span><span class="n">socket</span><span class="o">.</span><span class="n">AF_INET</span><span class="p">,</span> <span class="n">socket</span><span class="o">.</span><span class="n">SOCK_STREAM</span><span class="p">)</span>


<span class="k">print</span> <span class="n">mastersock</span><span class="o">.</span><span class="n">getsockname</span><span class="p">()</span>

<span class="c"># bind our mastersock to the above</span>
<span class="n">mastersock</span><span class="o">.</span><span class="n">bind</span><span class="p">(</span> <span class="p">(</span><span class="n">host</span><span class="p">,</span> <span class="n">port</span><span class="p">)</span> <span class="p">)</span>


<span class="k">print</span> <span class="n">mastersock</span><span class="o">.</span><span class="n">getsockname</span><span class="p">()</span>
<span class="c"># set the number of connections</span>
<span class="n">mastersock</span><span class="o">.</span><span class="n">listen</span><span class="p">(</span><span class="mi">2</span><span class="p">)</span>


<span class="c"># Example of what gets created in our Process when we spawn one with this package</span>

<span class="n">first_process</span> <span class="o">=</span> <span class="n">socket</span><span class="o">.</span><span class="n">socket</span><span class="p">(</span><span class="n">socket</span><span class="o">.</span><span class="n">AF_INET</span><span class="p">,</span> <span class="n">socket</span><span class="o">.</span><span class="n">SOCK_STREAM</span><span class="p">)</span>
<span class="n">first_process</span><span class="o">.</span><span class="n">connect</span><span class="p">(</span> <span class="p">(</span><span class="n">host</span><span class="p">,</span> <span class="n">port</span><span class="p">)</span> <span class="p">)</span>


<span class="sd">&quot;&quot;&quot;</span>
<span class="sd">When first_process called &#39;connect()&#39; with the mastersock&#39;s host and port,</span>
<span class="sd">mastersock received a connection request. When we accept that request our</span>
<span class="sd">mastersock or server socket returns to us a client socket, which is just a socket</span>
<span class="sd">whose sole purpose is to communicate with the socket that requested a connection.</span>

<span class="sd">Sockets are bidirectional, and this specific client socket will be communicating</span>
<span class="sd">only with the socket that made the request for it to exist. </span>

<span class="sd">addr is just the host and port of the socket requestion a connection</span>
<span class="sd">&quot;&quot;&quot;</span>

<span class="p">(</span><span class="n">client</span><span class="p">,</span> <span class="n">addr</span><span class="p">)</span> <span class="o">=</span> <span class="n">mastersock</span><span class="o">.</span><span class="n">accept</span><span class="p">()</span>

<span class="c"># let&#39;s send some data between the sockets</span>
<span class="n">first_process</span><span class="o">.</span><span class="n">send</span><span class="p">(</span><span class="s">&#39;sockets are cool&#39;</span><span class="p">)</span>

<span class="n">client</span><span class="o">.</span><span class="n">recv</span><span class="p">(</span><span class="mi">14</span><span class="p">)</span>


<span class="n">client</span><span class="o">.</span><span class="n">send</span><span class="p">(</span><span class="s">&#39;200&#39;</span><span class="p">)</span>

<span class="n">first_process</span><span class="o">.</span><span class="n">recv</span><span class="p">(</span><span class="mi">3</span><span class="p">)</span>
</pre></div>
...
<div class="input_area box-flex1">
<div class="highlight"><pre><span class="sd">&quot;&quot;&quot;</span>
<span class="sd">Second piece</span>

<span class="sd">Object to spawn and execute processes</span>

<span class="sd">We will want to do this inside of a separate terminal due to the package&#39;s lack of maturity</span>
<span class="sd">&quot;&quot;&quot;</span>
<span class="kn">from</span> <span class="nn">sockproc.spawn</span> <span class="kn">import</span> <span class="n">Pool</span>
<span class="kn">from</span> <span class="nn">sockproc.spawn</span> <span class="kn">import</span> <span class="n">count</span>

<span class="n">pool</span> <span class="o">=</span> <span class="n">Pool</span><span class="p">(</span><span class="mi">8</span><span class="p">,</span> <span class="n">count</span><span class="p">,</span> <span class="p">(</span><span class="mi">1</span><span class="p">,))</span>

<span class="s">&quot;&quot;&quot;</span>
<span class="s">The parameters as you can see are an integer, a function, and arguments to that function</span>

<span class="s">The integer argument is the number of processes to spawn off.</span>

<span class="s">The function argument is the task/job/function/method for the process to execute</span>

<span class="s">The arguments argument is the argument to the task/job/function/method or wtf ever you wanna call it</span>



<span class="s">You might be wondering how we spawn processes? Or maybe how we communicate the results of those processes&#39; jobs</span>
<span class="s">back to the master? Two things, a unix method called fork, and sockets.</span>

<span class="s">We also need a way of cleanup up our resources. We can&#39;t just have worker processes laying around doing nothing!</span>

<span class="s">Forking</span>
<span class="s"> - forking is a unix method by which a process clones itself. The cloned process is referred to as the child process</span>
<span class="s"> - the parent process is returned the Process ID of the child and the child is return a 0 for success</span>
<span class="s"> - we can use the aforementioned to tell which process we are inside of</span>
<span class="s"> </span>
<span class="s"> In our case we are calling the fork method 8 times, which results in 8 child processes.</span>
<span class="s"> </span>


<span class="s">Communicating to the master</span>
<span class="s"> It wouldn&#39;t be of much purpose to create these processes without a way to communicate the work</span>
<span class="s"> they did back to a master process.</span>
<span class="s"> </span>
<span class="s"> - using sockets we establish a connection between each forked child process and a master process</span>
<span class="s"> - the master creates client sockets to communicate with the requesting process</span>
<span class="s"> - after the jobs of each child process run their outputs as well as some other metadata are communicated back to master</span>
<span class="s"> </span>
<span class="s"> </span>
<span class="s"> </span>
<span class="s">Cleaning up our resources</span>

<span class="s"> - the MasterProcess class has an attribute called child_ids</span>
<span class="s"> - when each child is finished executing, it sends back the response containing metadata. that child&#39;s PID is in the metadata</span>
<span class="s"> - we can just call a unix kill -9 with the process id</span>
</pre></div>
...
<pre>
<span class="ansicyan"> File </span><span class="ansigreen">&quot;&lt;ipython-input-2-59355811932e&gt;&quot;</span><span class="ansicyan">, line </span><span class="ansigreen">52</span>
<span class="ansired"> - we can just call a unix kill -9 with the process id</span>
                                                         
^
<span class="ansired">SyntaxError</span><span class="ansired">:</span> EOF while scanning triple-quoted string literal
</pre>
</div>
</div>
...
<div class="input_area box-flex1">
<div class="highlight"><pre><span class="nb">dir</span><span class="p">(</span><span class="n">np</span><span class="p">)</span>
</pre></div>
...
<div class="input_area box-flex1">
<div class="highlight"><pre><span class="n">np</span><span class="o">.</span><span class="n">linalg</span><span class="p">(</span>
</pre></div>
